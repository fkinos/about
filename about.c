...
static void
draw_string_hcenter (int y, char *string, unsigned int color)
{
  int length = strlen (string);
  draw_string (WIDTH / 2 - ((8 * length) / 2), y, string, color);
}
...
draw ()
{
  ...
  draw_string (10, 10, "A small collection of", BLACK);
  draw_string (10, 20, "small applications for", BLACK);
  draw_string (10, 30, "your desktop.", BLACK);

  draw_string_hcenter (HEIGHT - 48, "Enjoy!", BLACK);
  draw_string_hcenter (HEIGHT - 32, "Made by fkinos", BLACK);
  draw_string_hcenter (HEIGHT - 16, "2024", BLACK);
}
